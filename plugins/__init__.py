...
@stark.on_message(filters.command(["start"]) & ~filters.forwarded)
...
@stark.on_message(filters.command(["restart"]) & ~filters.forwarded)
async def restart_handler(_, m):
    await m.reply_text("Restarted!", True)
    os.execl(sys.executable, sys.executable, *sys.argv)

@stark.on_message(filters.command(["log"]) & ~filters.forwarded)
